...
/***/ function(module, exports, __webpack_require__) {
	...
	var TargetSubPhrase = React.createClass({
	  ...
	  variationClasses: function variationClasses() {
	    return classNames({
	      'prompt': true,
	      'correct': this.state.isCorrect
	    });
	  ...
	  inputAnswer: function inputAnswer(evt) {
	  ...
	  render: function render() {
	    if (this.props.isInputField) {
	      return React.createElement(
	        'span',
	        { className: this.variationClasses() },
	        React.createElement('input', { type: 'text', className: 'user-input', onKeyUp: this.inputAnswer }),
	        React.createElement(
	          'span',
	          { className: 'prompt-know' },
	          this.props.phrase.know
	        )
	      );
	    } else {
	      return React.createElement(
	...
	var PhraseVariation = React.createClass({
	  ...
	  renderSubPhrase: function renderSubPhrase(sub) {
	    return React.createElement(TargetSubPhrase, { key: sub.id,
	      isInputField: this.props.replaceSubPhrase == sub,
	      phrase: this.props.variant,
	      sub: sub });
	  },

	  phraseDelimiter: function phraseDelimiter() {
	    return this.props.replaceSubPhrase;
	  },

	  // TODO: Extract to a module
	  parsePhraseSegments: function parsePhraseSegments() {
	...
	var VariationContainer = React.createClass({
	  displayName: 'VariationContainer',

	  renderVariant: function renderVariant(variant, index) {
	    return React.createElement(PhraseVariation, { key: variant.id,
	      variant: variant,
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      this.props.phrase.replace[0].variants.map(this.renderVariant)
	    );
	  }
	});
	...
	var Phrase = React.createClass({
	  ...
	  subIsReplaceable: function subIsReplaceable(sub) {
	    var subphrases = this.props.phrase.replace.filter(function (obj) {
	      return obj.word == sub;
	    });
	  ...
	  hasReplacements: function hasReplacements() {
	  ...
	  renderVariations: function renderVariations() {
	    ReactDOM.render(React.createElement(VariationContainer, { phrase: this.props.phrase }), document.getElementById('variations'));
	  },
	  ...
	  render: function render() {
	    return React.createElement(
	      'p',
	      { className: this.classes(), onClick: this.select },
	      this.parsePhraseSegments().map(this.renderSubPhrase)
	    );
	  }
	});
	...
	var Flashcard = React.createClass({
	  ...
	  render: function render() {
	    var renderPhrase = function renderPhrase(phrase, index) {
	      return React.createElement(Phrase, { key: phrase.id, phrase: phrase, isFirst: index == 0 });
	    };

	    return React.createElement(
	      'div',
	      { className: 'container' },
	      this.props.phrases.map(renderPhrase)
	    );
	  }
	});

	ReactDOM.render(React.createElement(Flashcard, { phrases: phrases }), document.getElementById('phrases'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".container, .variation-container {\n  text-align: center;\n  font-size: 24px;\n}\n\n.phrase {\n  font-size: 1em;\n  margin-left: 1em;\n  margin-bottom: 1em;\n  margin-top: 1em;\n  border: 1px solid;\n  padding: 1em;\n  width: 75%;\n}\n\n.phrase.first, .phrase-variation.first {\n  margin-top: 0;\n}\n\n.word {\n  vertical-align: top;\n  margin-right: 6px;\n}\n\n.replaceable {\n  background-color: yellow;\n  padding: 0 6px;\n  border: 1px solid;\n}\n\n.selected {\n  margin-left: 3em;\n}\n\n#variations, #phrases {\n  width: 50%;\n  display: inline-block;\n  vertical-align: top;\n}\n\n.phrase-variation {\n  border: 1px solid blue;\n  padding: 1em;\n  margin: 1em 0;\n}\n\n.prompt {\n  display: inline-block;\n}\n\n.user-input {\n  margin-top: 0.5em;\n  text-align: center;\n}\n\n.prompt-know {\n  display: block;\n  font-style: italic;\n  font-size: 0.6em;\n}\n\n.correct {\n  background-color: green;\n}\n", ""]);
